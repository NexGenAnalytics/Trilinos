...
EvaluatorTpetraDS651<Scalar, LO, GO, Node>::createGraph()
{
...
template<class Scalar, class LO, class GO, class Node>
void EvaluatorTpetraDS651<Scalar, LO, GO, Node>::
...
EvaluatorTpetraDS651<Scalar, LO, GO, Node>::get_x_space() const
{
  return xSpace_;
}
...
template<class Scalar, class LO, class GO, class Node>
Teuchos::RCP<const Thyra::VectorSpaceBase<Scalar> >
EvaluatorTpetraDS651<Scalar, LO, GO, Node>::get_f_space() const
{
  return fSpace_;
}
...
EvaluatorTpetraDS651<Scalar, LO, GO, Node>::getNominalValues() const
{
...
EvaluatorTpetraDS651<Scalar, LO, GO, Node>::create_W_op() const
{
...
EvaluatorTpetraDS651<Scalar, LO, GO, Node>::create_W_prec() const
{
  Teuchos::RCP<tpetra_matrix> W_tpetra = Teuchos::rcp(new tpetra_matrix(W_graph_));
...
template<class Scalar, class LO, class GO, class Node>
int EvaluatorTpetraDS651<Scalar, LO, GO, Node>::Np() const
{return Np_;}

template<class Scalar, class LO, class GO, class Node>
int EvaluatorTpetraDS651<Scalar, LO, GO, Node>::Ng() const
{return Ng_;}

template<class Scalar, class LO, class GO, class Node>
Teuchos::RCP<const ::Thyra::VectorSpaceBase<Scalar> >
EvaluatorTpetraDS651<Scalar, LO, GO, Node>::get_p_space(int /* l */) const
{
...
EvaluatorTpetraDS651<Scalar, LO, GO, Node>::get_p_names(int l) const
{
  return pNames_[l];
}
...
template<class Scalar, class LO, class GO, class Node>
Teuchos::RCP<const ::Thyra::VectorSpaceBase<Scalar> >
EvaluatorTpetraDS651<Scalar, LO, GO, Node>::get_g_space(int /* j */) const
{
  // All parameters are locally replicated scalars of size 1
  return gSpace_;
}
...
EvaluatorTpetraDS651<Scalar, LO, GO, Node>::get_g_names(int j) const
{
  return gNames_[j];
}
...
template<class Scalar, class LO, class GO, class Node>
Teuchos::RCP<::Thyra::LinearOpBase<Scalar>>
EvaluatorTpetraDS651<Scalar, LO, GO, Node>::create_DfDp_op(int l) const
{
...
template<class Scalar, class LO, class GO, class Node>
Teuchos::RCP<::Thyra::LinearOpBase<Scalar> >
EvaluatorTpetraDS651<Scalar, LO, GO, Node>::create_DgDx_op(int j) const
{
...
template<class Scalar, class LO, class GO, class Node>
Teuchos::RCP<::Thyra::LinearOpBase<Scalar> >
EvaluatorTpetraDS651<Scalar, LO, GO, Node>::create_DgDx_dot_op(int j) const
{
  TEUCHOS_ASSERT( (j == 4) || (j == 6) );
...
template<class Scalar, class LO, class GO, class Node>
::Teuchos::RCP<::Thyra::LinearOpBase<Scalar> >
EvaluatorTpetraDS651<Scalar, LO, GO, Node>::create_DgDp_op( int j, int l ) const
{
  TEUCHOS_ASSERT( (j == 4) || (j == 6) );
  TEUCHOS_ASSERT( (l == 2) || (l == 4) );
...
EvaluatorTpetraDS651<Scalar, LO, GO, Node>::get_W_factory() const
{
  return W_factory_;
}
...
template<class Scalar, class LO, class GO, class Node>
Thyra::ModelEvaluatorBase::InArgs<Scalar>
EvaluatorTpetraDS651<Scalar, LO, GO, Node>::createInArgs() const
{
...
EvaluatorTpetraDS651<Scalar, LO, GO, Node>::createOutArgs() const
{
          ...
          const Thyra::ModelEvaluatorBase::OutArgs<Scalar> &outArgs) const
{
  ...
  if (fill_f) {
    ...
    // Compute the residuals for the new system of equations
  ...
  if (fill_W) {
    ...
    // Compute the Jacobian for the new system of equations
  ...
  if (fill_W_prec) {
    ...
    // Compute the preconditioner for the new system of equations
  ...
  // Fill Responses (g4 and g6) and Sensitivities (Dg4Dx, Dg6Dx, DfDp2, DfDp4, Dg4Dp2, Dg4Dp4, Dg6Dp2, Dg6Dp4)
  ...
  if (fill_g4) {
    ...
    // Compute g4 for the new system of equations
    Scalar g4_val = x(numMyElements, 0) * x(numMyElements, 0) + x(numMyElements - 1, 0) * x(numMyElements - 1, 0) - 2.0;
    Teuchos::broadcast(*comm_, comm_->getSize() - 1, &g4_val);

    auto g4_host = g4_tpetra->getLocalViewHost(Tpetra::Access::ReadWrite);
    g4_host(0, 0) = g4_val;

    if (printDebug_)
      std::cout << "evalModel: g(4)=" << g4_val << std::endl;
  }

  if (fill_g6) {
    // Compute g6 for the new system of equations
    Scalar T_left = x(0, 0);
    Teuchos::broadcast(*comm_, 0, &T_left);

    Scalar T_right = x(numMyElements, 0);
    ...
    if (printDebug_)
      std::cout << "evalModel: g(6)=" << g6_host(0, 0) << std::endl;
  }
  ...
  if (fill_DfDp2) {
    ...
    // Compute DfDp2 for the new system of equations
  ...
  if (fill_DfDp4) {
    ...
    // Compute DfDp4 for the new system of equations
    if (comm_->getRank() == 0) {
...
template<class Scalar, class LO, class GO, class Node>
std::pair<int,int>
EvaluatorTpetraDS651<Scalar, LO, GO, Node>::get_p_index(const std::string& p_name) const
{
...
template<class Scalar, class LO, class GO, class Node>
std::pair<int,int>
EvaluatorTpetraDS651<Scalar, LO, GO, Node>::get_g_index(const std::string& g_name) const
{
